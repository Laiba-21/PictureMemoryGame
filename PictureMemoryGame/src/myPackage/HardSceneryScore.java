...
public class HardSceneryScore extends JFrame implements ActionListener
{
	...
	JFrame HardSceneryScoreFrame =new JFrame();
	JTextField textfield=new JTextField();
	
	
   public  HardSceneryScore()
   {
...
HardSceneryScoreFrame  =new JFrame();
HardSceneryScoreFrame .setTitle("Memory Game");
HardSceneryScoreFrame .setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
HardSceneryScoreFrame .getAlignmentX();
HardSceneryScoreFrame .setVisible(true);
HardSceneryScoreFrame .setResizable(false);
HardSceneryScoreFrame .setLayout(null);
HardSceneryScoreFrame .setSize(550, 570);

HardSceneryScoreFrame .getContentPane().setBackground(Color.white);
HardSceneryScoreFrame .setIconImage(logo4.getImage());
...
HardSceneryScoreFrame .add(orangePanel);
...
public void compare()
   {
	   ...
	   List<String> objects= new ArrayList<String>();
		...
		objects.add("rabbit");
		objects.add("cottage");
		objects.add("butterflies");
		objects.add("flowers");
		objects.add("birds");
		objects.add("mushrooms");
		objects.add("trees");
		objects.add("fence");
		objects.add("sand road");
		objects.add("pebbles");
