...
public class EasyHouseScore extends JFrame implements ActionListener
{
	...
	JFrame EasyHouseScoreFrame =new JFrame();
	JTextField textfield=new JTextField();
	
   public EasyHouseScore()
   {
...
EasyHouseScoreFrame=new JFrame();
EasyHouseScoreFrame.setTitle("Memory Game");
EasyHouseScoreFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
EasyHouseScoreFrame.getAlignmentX();
EasyHouseScoreFrame.setVisible(true);
EasyHouseScoreFrame.setResizable(false);
EasyHouseScoreFrame.setLayout(null);
EasyHouseScoreFrame.setSize(550, 570);

EasyHouseScoreFrame.getContentPane().setBackground(Color.white);
EasyHouseScoreFrame.setIconImage(logo4.getImage());
...
EasyHouseScoreFrame.add(orangePanel);
