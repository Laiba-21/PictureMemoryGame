...
public class NormalHouseScore extends JFrame implements ActionListener
{
...
public void compare()
   {
	   ...
	   List<String> objects= new ArrayList<String>();
		...
		objects.add("picture frame");
		objects.add("round carpet");
		objects.add("TV");
		objects.add("buttons");
		objects.add("curtains");
		objects.add("cup");
