...
public class HardSchoolScore extends JFrame implements ActionListener
{
	...
	JFrame HardScoreFrame =new JFrame();
	JTextField textfield=new JTextField();
	
	
   public  HardSchoolScore()
   {
...
HardScoreFrame  =new JFrame();
HardScoreFrame .setTitle("Memory Game");
HardScoreFrame .setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
HardScoreFrame .getAlignmentX();
HardScoreFrame .setVisible(true);
HardScoreFrame .setResizable(false);
HardScoreFrame .setLayout(null);
HardScoreFrame .setSize(550, 570);

HardScoreFrame .getContentPane().setBackground(Color.white);
HardScoreFrame .setIconImage(logo4.getImage());
...
HardScoreFrame .add(orangePanel);
...
public void compare()
   {
	   ...
	   List<String> objects= new ArrayList<String>();
		...
		objects.add("flags");
		objects.add("swings");
		objects.add("kangaroo jumping bags");
		objects.add("clock");
