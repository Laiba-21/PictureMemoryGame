...
public class HardHouseScore extends JFrame implements ActionListener
{
...
public void compare()
   {
	   ...
	   List<String> objects= new ArrayList<String>();
		...
		objects.add("bulb");
		objects.add("cupboards");
		objects.add("tissue roll");
		objects.add("glove");
		objects.add("stove");
		objects.add("toaster");
		objects.add("kettle");
		objects.add("jucier machine");
		objects.add("dishes");
		objects.add("sink");
