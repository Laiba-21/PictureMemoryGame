...
public class NormalStreetScore extends JFrame implements ActionListener
{
...
public void compare()
   {
	   ...
	   List<String> objects= new ArrayList<String>();
		...
		objects.add("cloths");
		objects.add("street lamps");
		objects.add("plant pot");
		objects.add("houses");
		objects.add("plants");
