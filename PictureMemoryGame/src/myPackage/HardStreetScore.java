...
public class HardStreetScore extends JFrame implements ActionListener
{
...
public void compare()
   {
	   ...
	   List<String> objects= new ArrayList<String>();
		...
		objects.add("car");
		objects.add("bicycle");
		objects.add("light poles");
		objects.add("traffic signals");
		objects.add("sign boards");
