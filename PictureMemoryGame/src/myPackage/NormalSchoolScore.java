...
public class NormalSchoolScore extends JFrame implements ActionListener
{
	...
	JFrame NormalScoreFrame =new JFrame();
	JTextField textfield=new JTextField();
	
	
   public NormalSchoolScore()
   {
...
NormalScoreFrame  =new JFrame();
NormalScoreFrame .setTitle("Memory Game");
NormalScoreFrame .setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
NormalScoreFrame .getAlignmentX();
NormalScoreFrame .setVisible(true);
NormalScoreFrame .setResizable(false);
NormalScoreFrame .setLayout(null);
NormalScoreFrame .setSize(550, 570);

NormalScoreFrame .getContentPane().setBackground(Color.white);
NormalScoreFrame .setIconImage(logo4.getImage());
...
NormalScoreFrame .add(orangePanel);
...
public void compare()
   {
	   ...
	   List<String> objects= new ArrayList<String>();
		...
		objects.add("school board");
		objects.add("school building");
		objects.add("students");
		objects.add("school bus");
		objects.add("windows");
		objects.add("clock");
		objects.add("trees");
		objects.add("football");
