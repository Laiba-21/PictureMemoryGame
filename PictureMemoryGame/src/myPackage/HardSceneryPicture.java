...
public class HardSceneryPicture extends JFrame implements ActionListener

{
	...
	public  HardSceneryPicture()
	{
        ...
        ImageIcon HardScenery= new ImageIcon("HardScenery.jpg");
        HardPiclabel2.setIcon(HardScenery);	
...
public void actionPerformed(ActionEvent e) 
{
	
	{
		...
		HardSceneryScore sw1=new HardSceneryScore();
		sw1.setVisible(true);
