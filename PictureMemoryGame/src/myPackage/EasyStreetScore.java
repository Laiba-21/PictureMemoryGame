...
public class EasyStreetScore  extends JFrame implements ActionListener
{
	...
	JFrame EasyScoreFrame =new JFrame();
	JTextField textfield=new JTextField();
   public EasyStreetScore ()
   {
...
EasyScoreFrame =new JFrame();
EasyScoreFrame.setTitle("Memory Game");
EasyScoreFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
EasyScoreFrame.getAlignmentX();
EasyScoreFrame.setVisible(true);
EasyScoreFrame.setResizable(false);
EasyScoreFrame.setLayout(null);
EasyScoreFrame.setSize(550, 570);

EasyScoreFrame.getContentPane().setBackground(Color.white);
EasyScoreFrame.setIconImage(logo4.getImage());
...
EasyScoreFrame.add(orangePanel);
