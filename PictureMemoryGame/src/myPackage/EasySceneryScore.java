...
public class EasySceneryScore extends JFrame implements ActionListener
{
	...
	JFrame EasySceneryScoreFrame =new JFrame();
	JTextField textfield=new JTextField();
   public  EasySceneryScore()
   {
...
EasySceneryScoreFrame =new JFrame();
EasySceneryScoreFrame.setTitle("Memory Game");
EasySceneryScoreFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
EasySceneryScoreFrame.getAlignmentX();
EasySceneryScoreFrame.setVisible(true);
EasySceneryScoreFrame.setResizable(false);
EasySceneryScoreFrame.setLayout(null);
EasySceneryScoreFrame.setSize(550, 570);

EasySceneryScoreFrame.getContentPane().setBackground(Color.white);
EasySceneryScoreFrame.setIconImage(logo4.getImage());
...
EasySceneryScoreFrame.add(orangePanel);
