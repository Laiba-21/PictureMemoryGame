...
public class NormalHousePicture extends JFrame implements ActionListener

{
	...
	public   NormalHousePicture()
	{
        ...
        ImageIcon NormalPicture= new ImageIcon("NormalHouse.jpg");
...
public void actionPerformed(ActionEvent e) 
{
	
	{
		...
		NormalHouseScore sw1=new NormalHouseScore();
		sw1.setVisible(true);
