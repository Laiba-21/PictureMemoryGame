...
public class NormalSceneryPicture extends JFrame implements ActionListener

{
	...
	public   NormalSceneryPicture()
	{
        ...
        ImageIcon NormalPicture= new ImageIcon("NormalScenery.jpg");
...
normalPicframe.setSize(570, 450);
...
public void actionPerformed(ActionEvent e) 
{
	
	{
		...
		NormalSceneryScore sw1=new NormalSceneryScore();
		sw1.setVisible(true);
